...
export const StaggeredMenu = ({
  ...
  const outerStyle = isFixed
    ? { position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', overflow: 'hidden', zIndex: 40, pointerEvents: 'none' }
    : { width: '100%', height: '100%', zIndex: 40, pointerEvents: 'none' };

  return (
    <div className="sm-scope" style={outerStyle}>
      <div
      ...
      <style>{`
        ...
        /* ── Spacer (mirrors toggle btn width for centering) ─── */
        .sm-scope .sm-header-spacer {
          width: 80px;          /* approximate toggle button width */
          flex-shrink: 0;
          pointer-events: none;
        }
        ...
        .sm-scope .sm-panel-itemWrap:first-child {
